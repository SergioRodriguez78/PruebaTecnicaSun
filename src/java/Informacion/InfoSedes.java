...
public class InfoSedes {
    ...
    private static List<String> sedes = new ArrayList<>();
    private static List<String> dane = new ArrayList<>();

    public InfoSedes() {
    }

    public static List<String> getSedes() {
        return sedes;
    }

    public static void setSedes(List<String> sedes) {
        InfoSedes.sedes = sedes;
    }
    ...
    public void setdatos(String daneInstitucion) {
        ...
        try {
            ...
            //Mensaje post
            postData.append("User=etraining&Password=explorandoando2020%&option=sedes&CodInst=");
            postData.append(daneInstitucion);
